...
1. Set the ANDROID\_HOME environment variable to point to the location of your installed Android SDK 2.3 API level 10. For more information, look at [the documentation of maven-android-plugin](http://code.google.com/p/maven-android-plugin/wiki/GettingStarted).
