...
public class EligibleCoupleRepositoryTest extends AndroidTestCase {
    ...
    public void testShouldInsertEligibleCoupleIntoRepository() throws Exception {
        repository.add(new Action("CASE X", "createEC", dataForCreateAction("Wife 1", "Husband 1", "EC Number"), "0"));
    ...
    public void testShouldDeleteEligibleCoupleFromRepositoryBasedOnCaseID() throws Exception {
        repository.add(new Action("CASE X", "createEC", dataForCreateAction("Wife 1", "Husband 1", "EC Number 1"), "0"));
        repository.add(new Action("CASE Y", "createEC", dataForCreateAction("Wife 2", "Husband 2", "EC Number 2"), "0"));
    ...
    private Map<String, String> dataForCreateAction(String wife, String husband, String ecNumber) {
