...
function program15(depth0,data,depth1) {
  ...
  stack1 = helpers['if'].call(depth0, stack1, {hash:{},inverse:self.programWithDepth(program18, data, depth1),fn:self.programWithDepth(program16, data, depth1)});
...
function program20(depth0,data,depth1) {
  ...
  buffer += "\n            ";
  stack1 = depth0.isCompleted;
  stack1 = helpers['if'].call(depth0, stack1, {hash:{},inverse:self.programWithDepth(program23, data, depth1),fn:self.programWithDepth(program21, data, depth1)});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n        ";
  return buffer;}
...
function program35(depth0,data) {
  ...
  stack1 = helpers.each.call(depth0, stack1, {hash:{},inverse:self.noop,fn:self.programWithDepth(program15, data, depth0)});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n        ";
  stack1 = depth0.todos;
  ...
  stack1 = stack1 == null || stack1 === false ? stack1 : stack1.isHighRisk;
  foundHelper = helpers.ifFalse;
  stack1 = foundHelper ? foundHelper.call(depth0, stack1, {hash:{},inverse:self.program(27, program27, data),fn:self.program(25, program25, data)}) : helperMissing.call(depth0, "ifFalse", stack1, {hash:{},inverse:self.program(27, program27, data),fn:self.program(25, program25, data)});
  if(stack1 || stack1 === 0) { buffer += stack1; }
