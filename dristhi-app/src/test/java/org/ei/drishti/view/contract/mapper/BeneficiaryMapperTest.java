...
public class BeneficiaryMapperTest {
    ...
    public void shouldMapChildrenToBeneficiaries() throws Exception {
        Child child1 = new Child("CASE X", "MOTHER CASE X", "TC 1", "01/01/2008", "male", mapOf("isHighRiskChild", "yes"));
        ...
        List<Beneficiary> beneficiaries = mapper.mapFromChildren(asList(child1, child2));
    ...
    @Test
    public void shouldMapMothersToBeneficiaries() throws Exception {
        ...
        List<Beneficiary> beneficiaries = mapper.mapFromMothers(asList(mother1, mother2));
