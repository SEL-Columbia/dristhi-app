...
public class ChildListViewControllerTest {
    ...
    public void shouldSortBothNormalAndHighANCsByName() throws Exception {
        when(allBeneficiaries.allChildren()).thenReturn(asList(
                new Child("Case 1", "Mother Case 1", "TC 1", "2032-01-01", "male", create("isHighRisk", "no").put("deliveryPlace", "Bherya DC").map()),
                new Child("Case 2", "Mother Case 2", "TC 2", "2032-02-02", "female", create("isHighRisk", "yes").put("deliveryPlace", "Bherya DC").map())));
