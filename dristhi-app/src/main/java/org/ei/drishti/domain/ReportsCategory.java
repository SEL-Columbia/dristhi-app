...
public enum ReportsCategory {
    ...
    CHILD_SERVICES("Child Services", asList(INFANT_BALANCE_ON_HAND, INFANT_REG, INFANT_BALANCE_TOTAL, INFANT_LEFT, PENTAVALENT3_OR_OPV3,
            DPT_BOOSTER_OR_OPV_BOOSTER, DPT_BOOSTER2, HEP, OPV, MEASLES,
            ...
            CHILD_DIARRHEA, INFANT_MORTALITY,
