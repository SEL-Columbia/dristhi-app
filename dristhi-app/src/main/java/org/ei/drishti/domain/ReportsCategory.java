...
public enum ReportsCategory {
    ...
    PREGNANCY_OUTCOMES("Pregnancy Outcomes", asList(LIVE_BIRTH, STILL_BIRTH, EARLY_ABORTIONS, LATE_ABORTIONS, SPONTANEOUS_ABORTION, DELIVERY, INSTITUTIONAL_DELIVERY, D_HOM, D_SC, D_PHC, D_CHC, D_SDH, D_DH, D_PRI)),
    PNC_SERVICES("PNC Services", asList(PNC3)),
    CHILD_SERVICES("Child Services", asList(DPT1, DPT2, DPT2, DPT3, DPT3_OR_OPV3, DPT_BOOSTER_OR_OPV_BOOSTER, DPT_BOOSTER2, HEP, OPV, MEASLES, BCG, LBW, BF_POST_BIRTH, WEIGHED_AT_BIRTH, VIT_A_1, VIT_A_2)),
