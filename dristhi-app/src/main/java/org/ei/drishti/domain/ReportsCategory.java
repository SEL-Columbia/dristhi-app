...
public enum ReportsCategory {
    ...
    CHILD_SERVICES("Child Services", asList(DPT3_OR_OPV3, DPT_BOOSTER_OR_OPV_BOOSTER, DPT_BOOSTER2, HEP, OPV, MEASLES, BCG, LBW, BF_POST_BIRTH, WEIGHED_AT_BIRTH, VIT_A_1, VIT_A_2, INFANT_MORTALITY)),
