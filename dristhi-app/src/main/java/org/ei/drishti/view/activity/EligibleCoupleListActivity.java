...
public class EligibleCoupleListActivity extends SecuredWebActivity {
    ...
    protected void onInitialization() {
        webView.addJavascriptInterface(new EligibleCoupleListViewController(context.allEligibleCouples(), context.allBeneficiaries(), context.listCache(), this, context.commCareClientService()), "context");
