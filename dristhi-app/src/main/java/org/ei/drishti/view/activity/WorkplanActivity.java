...
public class WorkplanActivity extends SecuredWebActivity {
    ...
    protected void onInitialization() {
        webView.addJavascriptInterface(new WorkplanController(context.allAlerts(), context.allSettings(), context.commCareClientService(), context.allEligibleCouples(), this), "context");
