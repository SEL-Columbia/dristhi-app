...
public class ChildDetailActivity extends SecuredWebActivity {
    ...
    protected void onInitialization() {
        ...
        webView.addJavascriptInterface(new ChildDetailController(this, caseId, context.allEligibleCouples(), context.allBeneficiaries(), context.allAlerts(), context.allTimelineEvents(), context.commCareClientService()), "context");
