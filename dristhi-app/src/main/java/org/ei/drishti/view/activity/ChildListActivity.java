...
public class ChildListActivity extends SecuredWebActivity {
    ...
    protected void onInitialization() {
        webView.addJavascriptInterface(new ChildListViewController(this, context.allBeneficiaries(), context.allEligibleCouples(), context.allSettings(), context.listCache()), "context");
