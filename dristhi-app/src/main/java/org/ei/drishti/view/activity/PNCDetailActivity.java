...
public class PNCDetailActivity extends SecuredWebActivity {
    ...
    protected void onInitialization() {
        ...
        webView.addJavascriptInterface(new PNCDetailController(this, caseId, context.allEligibleCouples(), context.allBeneficiaries(), context.allAlerts(), context.allTimelineEvents(), context.commCareClientService()), "context");
