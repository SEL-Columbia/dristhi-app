...
public class AllEligibleCouplesTest {
    ...
    public void shouldInsertAndDeleteECActionsBasedOnTheirType() throws Exception {
        Action firstCreateAction = actionForCreateEC("Case X", "Theresa 1", "Husband 1", "EC Number 1");
        Action firstDeleteAction = actionForDeleteEC("Case Y");
        Action secondCreateAction = actionForCreateEC("Case Z", "Theresa 2", "Husband 2", "EC Number 2");
