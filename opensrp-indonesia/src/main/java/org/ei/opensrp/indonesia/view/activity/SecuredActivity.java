...
public abstract class SecuredActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = org.ei.opensrp.indonesia.Context.getInstance().updateApplicationContext(this.getApplicationContext());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == org.ei.opensrp.R.id.switchLanguageMenuItem) {
